...
public class Renderer {
    ...
    private void setupSceneShader() throws Exception {
        ...
        sceneShaderProgram.createVertexShader(Utils.loadResource("/res/shaders/vertex.vs"));
        sceneShaderProgram.createFragmentShader(Utils.loadResource("/res/shaders/fragment.fs"));
    ...
    //deals with window resizing, binds the sceneShaderProgram, and draws the mesh then unbinds the sceneShaderProgram
