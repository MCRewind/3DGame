...
public class FontTexture {
	...
	private String getAllAvailableChars(String charsetName){
		...
		//appends all available charachters in the givel charset to a StringBuilder object
	...
	private void buildTexture() throws Exception {
		...
		//Test line to visualise the font image
	 ...
	 // An object that represents a starting x position and a width to represent a specific character
